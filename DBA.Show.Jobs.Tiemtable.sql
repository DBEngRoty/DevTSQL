...
--DROP TABLE StageDB.dbo.JobsTimeTable
SELECT sysjobs.name AS JOB_NAME, CAST((sysjobschedules.active_start_time / 10000) AS VARCHAR(10)) + ':' + 
...
sysjobschedules.active_start_time, sysjobschedules.active_end_time) AS Schedule, sysjobs.enabled 
INTO StageDB.dbo.JobsTimeTable
