...
DECLARE @SourceObject	varchar(128) 	-- null for all objects
DECLARE @SourceUID	varchar(128) 	-- null for trusted connection
DECLARE @SourcePWD	varchar(128) 
DECLARE @OutFilePath	varchar(256) 
DECLARE @OutFileName	varchar(128)   -- null for separate file per object script
DECLARE @ObjectType	varchar(50)    -- PROCS, FUNCTIONS, TABLES, VIEWS, INDEXES
DECLARE @WorkPath	varchar(256) 
DECLARE @SourceSVR	varchar(128)

-- Setup
SET @SourceDB	= 'StoreDB' 
SET @SourceObject	= NULL 	-- null for all objects
SET @SourceUID	=  null 	-- null for trusted connection
SET @SourcePWD	=  null 
SET @OutFilePath 	= 'C:\CDI13\' 
SET @OutFileName	= 'StoreDB_Tables.sql'   -- null for separate file per object script
SET @ObjectType	= 'TABLES' 	-- PROCS, FUNCTIONS, TABLES, VIEWS, INDEXES
SET @WorkPath	= 'C:\' 
SET @SourceSVR	= 'CDI13'
